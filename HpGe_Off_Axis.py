...
# folder path
dir_path = r"C:\Users\Home\Desktop\Lab Data Master\Ge Cs137 Angles"
...
COUNTS_M_120 = (np.genfromtxt(res[0],skip_header=12,skip_footer=17))/300
COUNTS_M_90 = (np.genfromtxt(res[3],skip_header=12,skip_footer=17))/300
COUNTS_M_60 = (np.genfromtxt(res[2],skip_header=12,skip_footer=17))/300
COUNTS_M_30 = (np.genfromtxt(res[1],skip_header=12,skip_footer=17))/300
COUNTS_0 = (np.genfromtxt(res[4],skip_header=12,skip_footer=17))/300
COUNTS_30 = (np.genfromtxt(res[6],skip_header=12,skip_footer=17))/300
COUNTS_60 = (np.genfromtxt(res[7],skip_header=12,skip_footer=17))/300
COUNTS_90 = (np.genfromtxt(res[8],skip_header=12,skip_footer=17))/300
COUNTS_120 = (np.genfromtxt(res[5],skip_header=12,skip_footer=17))/300
Roi_Start = 2450
Roi_End = 2590
Top = 6
...
half_life = 949038600
lam = 0.693/half_life
t_Ge = 1377228322  #am ba- cs co

#activity of lab 2 sources
A_cs2 = 37000*12.41*np.exp(-lam*t_Ge)*300
...
fig.suptitle('HpGe Cs137 Efficencys vs Angle')
