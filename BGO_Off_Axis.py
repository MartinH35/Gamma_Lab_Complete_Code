...
# folder path
dir_path = r"C:\Users\Home\Desktop\Lab Data Master\BGO Am Angles"
...
COUNTS_M_120 = (np.genfromtxt(res[0],skip_header=12,skip_footer=14))/240
COUNTS_M_90 = (np.genfromtxt(res[3],skip_header=12,skip_footer=14))/240
COUNTS_M_60 = (np.genfromtxt(res[2],skip_header=12,skip_footer=14))/240
COUNTS_M_30 = (np.genfromtxt(res[1],skip_header=12,skip_footer=14))/240
COUNTS_0 = (np.genfromtxt(res[4],skip_header=12,skip_footer=14))/299
COUNTS_30 = (np.genfromtxt(res[6],skip_header=12,skip_footer=14))/240
COUNTS_60 = (np.genfromtxt(res[7],skip_header=12,skip_footer=14))/240
COUNTS_90 = (np.genfromtxt(res[8],skip_header=12,skip_footer=14))/240
COUNTS_120 = (np.genfromtxt(res[5],skip_header=12,skip_footer=14))/240
Roi_Start = 10
Roi_End = 60
Top = 90
...
#activity of lab 2 source
A_am1 = 37000*11.16*np.exp(-lam*t_BGO)*299
...
fig.suptitle('BGO Am241 Efficencys vs Angle')
